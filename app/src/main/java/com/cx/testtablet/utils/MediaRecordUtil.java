...
public class MediaRecordUtil {
    ...
    public MediaRecordUtil(){
        ...
        this(Environment.getExternalStorageDirectory().getAbsolutePath()+"/TestTablet/");
    }
    ...
    public void startRecord() {
        ...
        try {
            ...
            Log.e(TAG,"utils : filePath == "+filePath);
            /* ③准备 */
...
//            updateMicStatus();
            ...
            e.printStackTrace();
            Log.e(TAG, "call startAmr(File mRecAudioFile) failed!" + e.toString());
        } catch (IOException e) {
            e.printStackTrace();
            Log.e(TAG, "call startAmr(File mRecAudioFile) failed!" + e.toString());
        }
